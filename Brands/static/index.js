...
$(document).ready(function () {
  ...
  $(".product-box-layout4").click(function () {
    ...
    if ($(this)[0].className.search("Lakme productClicked") > -1) {
      $("#Lakme").show().siblings("div").hide();

      $("html, body").animate(
        {
          scrollTop: $("#Lakme").offset().top,
        },
        800,
        function () {}
      );
    } else if ($(this)[0].className.search("blueheaven productClicked") > -1) {
      $("#blueheaven").show().siblings("div").hide();

      $("html, body").animate(
        {
          scrollTop: $("#blueheaven").offset().top,
        },
        800,
        function () {}
      );
    } else if ($(this)[0].className.search("Maybelline productClicked") > -1) {
      $("#Maybelline").show().siblings("div").hide();

      $("html, body").animate(
        {
          scrollTop: $("#Maybelline").offset().top,
        },
        800,
        function () {}
      );
